        ...
        for(i in 0 until length){
            response.getJSONObject(i).apply {
                trainee = Trainee(
                    ...
                    trainingStatus = getString("trainingStatus"),
                    batchId = getLong("batchId"),
                    phoneNumber = getString("phoneNumber"),
                    skypeId = getString("skypeId"),
                    profileUrl = getString("profileUrl"),
                    recruiterName = getString("recruiterName"),
                    college = getString("college"),
                    degree = getString("degree"),
                    major = getString("major"),
                    techScreenerName = getString("techScreenerName"),
                    techScreenScore = get("techScreenScore"),
                    projectCompletion = getString("projectCompletion"),
