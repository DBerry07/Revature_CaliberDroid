...
import com.revature.caliberdroid.ui.assessbatch.assessweekview.overview.assessment.AssessmentTraineeGradesFragment
...
class AssessWeekViewPagerAdapter(val fm: FragmentManager, val behavior: Int) : FragmentPagerAdapter(fm, behavior) {
    ...
    override fun getItem(position: Int): Fragment {
        ...
        return when (position) {
            ...
            else -> AssessmentTraineeGradesFragment()
        }
    }
