...
object BatchRepository {
    ...
    fun getAuditWeekNotes(batch: Batch, liveData: ListLiveData<AuditWeekNotes>) /*LiveData<ArrayList<WeekLiveData>>*/ {
...
////            })
//
//            liveData.addItem(AuditWeekNotes(i, overallStatus = null, overallNotes = null))
//        }
